...
from config import REPO_NAME, ROOT, CKPT_PATH
...
dataset = LeRobotDataset(REPO_NAME, delta_timestamps=delta_timestamps, root=ROOT, image_transforms=transform)
...
test_dataloader = torch.utils.data.DataLoader(dataset, num_workers=4,
    batch_size=1, shuffle=False,
    pin_memory=device.type!= "cpu", sampler=episode_sampler,
)
policy.reset()
